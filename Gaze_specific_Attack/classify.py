...
import math, evolve
# evaluation classifier that predicts the identity based on the input reconstructed image.
# VGG16 pretrained model input(64,64)
# CE Loss
# Binary Loss
# FaceNet input 112*112 output 1000 classes
# IR152
# IR50 Backbone64
...
class FaceNet(nn.Module):
    def __init__(self, num_classes = 1000):
        ...
        self.feature = evolve.IR_50_112((112, 112))  # backbone112 input image 112*112
        self.feat_dim = 512   # len(feature vector) = 512
