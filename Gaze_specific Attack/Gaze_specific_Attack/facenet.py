...
'''
FaceNet input image size is (112, 112) Output: feature feat, classification probability out, and index iden corresponding to the maximum classification probability
FaceNet64 input image size is (64, 64)
...
class FaceNet64(nn.Module):
    def __init__(self, num_classes = 10): #1000
