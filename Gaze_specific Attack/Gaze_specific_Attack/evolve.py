...
# Identity Residual with Squeeze-and-Excitation
# SEModule inhance the capability of CNN. 2 conv ,Don‘t change channel number
# bottleneck_IR res-block, 2 conv layers
# bottleneck_IR_SE = bottleneck_IR + SEModule
